...
X = data(:, [1, 2]);        %The first two column vectors of exam scores
y = data(:, 3);             % label vector

%% ==================== Plotting ====================
%  Plotting the data to understand to the problem we are working with.
...
%  After learning the parameters,  predict the outcomes
%  on unseen data. 
